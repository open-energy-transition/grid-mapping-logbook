...
![alt text](<images/delta-morocco-2025-04-01.png>)
...
The satellite images were of varying qualities for different regions, so I had to combine all sources available. 
...
Before my mapping activity the grid had several gaps that needed to be filled. 

**Success Stories** 
1. Added several substations around the country, using satellite images.
2. I was able to extend lines and connect them to the grid
...
6. There are errors in the past mapping that could be resolved.
...
![alt text](<images/morocco-2025-04-01.png>)
